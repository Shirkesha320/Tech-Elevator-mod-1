...
/*
	...
	public boolean endsLy(String str) {
		...
		return (str.substring(str.length() - 2, str.length()).contentEquals("ly"));
	}
	...
	public boolean hasBad(String str) {
		if (str.length () <= 2) {
			...
			return ((str.subSequence(0, 3)).equals("bad") || str.subSequence(1, 4).equals("bad"));
	...
	public String frontTimes(String str, int n) {
		...
		if (str.length() > 3) { // find out if its less 3
			fLetters = str.substring(0, 3);
		}
		else {
			 fLetters = str.substring(0);
			}
		String flettersCopy = "";
		
		for (int i = 0; i < n; i ++) {
			flettersCopy += fLetters;
		}
	...
	public String altPairs(String str) {
		...
		for (int i = 0; i < str.length(); i += 4) {
			if (i == str.length() - 1) {
			answer = answer + str.substring(i);
			
			}else if (i <str.length()) {
				answer = answer + str.substring(i, i  + 2);
			}
		}
	...
	public String stringYak(String str) {
		...
		int pakYak = str.indexOf("yak");
		while (pakYak != - 1) {
			str = str.substring(0, pakYak) + str.substring(pakYak + 3);
			pakYak = str.indexOf("yak");
		}
		return str;
	}
