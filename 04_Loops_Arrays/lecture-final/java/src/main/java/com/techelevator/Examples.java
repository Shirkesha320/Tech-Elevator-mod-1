...
public class Examples {
	...
	public static void main(String[] args) {
		...
		// when the ++ is used as a prefix operator the increment is performed before 
		//evalutation
		System.out.println("x = 1");
		x = 1;
		System.out.println("y = ++x");
		...
		/* Arrays are Objects, so they are "passed by reference".  In other words. 
		 * when assigning
		 * the value of one array variable to another array variable, 
		 * we are assigning a reference
