...
public class Exercises {
	...
	/*
	 ...
	 If the array length
	  is less than 2, just sum up the elements that exist, returning 0 if the array 
	  is length 0.
	 sum2([1, 2, 3]) → 3
	 sum2([1, 1]) → 2
	 sum2([1, 1, 1, 1]) → 2
	...
	/*
	 11. Return the number of even ints in the given array. Note: the % "mod" operator 
	 computes the 
