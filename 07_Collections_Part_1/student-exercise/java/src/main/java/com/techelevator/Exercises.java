...
public class Exercises {
	...
	public List<String> no4LetterWords(String[] stringArray) {
		...
		for (String element: stringArray) {//how does it know
			if (element.length() != 4) {
				notFourLetters.add(element);
			}
		...
		//String[] listArray(List<String> stringList) {
			
			//String[] listArray = stringList
	...
	public List<Double> arrayInt2ListDouble(int[] intArray) {
		ArrayList<Double> arrayListDubs = new ArrayList<>();
		for (double number : intArray) {
			arrayListDubs.add(number / 2);
		}
				
		return arrayListDubs;
	}
